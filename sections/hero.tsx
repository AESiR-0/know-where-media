...
import bg from "@/public/static/landing/hero.png";

const Home: NextPage = () => {
  return (
    <div
      style={{ backgroundImage: `url(${bg.src})` }}
      className={`text-white bg-no-repeat bg-cover bg-center h-[125vh] bg-black flex items-center justify-center`}
    >
      {/* Navigation bar */}
      ...
      <div className="-mt-20 text-center px-4 md:px-0">
        <div className="gap-4 flex flex-col items-center md:space-y-5">
          <div className="space-y-3">
            <h2 className="max-md:text-2xl md:text-6xl  font-spaceGrotesk font-semibold">
              From Nowhere to Knowhere
            </h2>
            <h1 className="landig-css max-w-6xl max-md:max-w-8xl max-md:px-0 font-oswald uppercase  max-md:text-6xl md:text-9xl ">
